...
class Particle(object):
    def __init__(self, j_dim, i_dim, ranges, upbound_of_SD, v_max):
        ...
        # individual = > 'theta', 'w', 'm', 'sd', 'adapt_value'
        ...
        # p-vector record the best location found by particle so far
        ...
        # v-vector record the best location found by particle so far
