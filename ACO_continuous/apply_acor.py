...
ranges = [[-512,512],[-512,512],[-512,512],[-512,512],[-512,512],[-512,512],[-512,512],[-512,512],[-512,512], [-512,512]]

functions = [rosenbrock.Rosenbrock(10), rastrigin.Rastrigin(10), sphere.Sphere(10), styblinski_tang.StyblinskiTang(10)] 
for function in functions:
	colony.set_cost(function.cost)
	colony.set_variables(10, ranges)
